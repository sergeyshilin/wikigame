        ...
        <div id="game-type-grid">
            <div class="row row-eq-height">
                <div class="game-type col-sm-4">
                    ...
                    <div class="game-type-text" onclick="goto('wiki/Main_Page')">
                        <h3>Классический</h3>
            ...
            <div class="row row-eq-height">
                ...
                <div class="game-type col-sm-4">
                    <img src="application/images/game_types/wki_icon-04.png" onclick="runIfLoggedIn(goto, 'challenge')">
                    <div class="game-type-text" onclick="runIfLoggedIn(goto, 'challenge')">
                        <h3>Дуэль</h3>
