                    ...
                    <div class="game-type-grid" style="color: #000; text-shadow: none">
                        <div class="row row-eq-height">
                            <div class="game-type col-sm-4">
                                <img src="application/images/game_types/wki_icon-02.png" class="invert" onclick="gotoCustom('classic/custom_way')">
                                <div class="game-type-text" onclick="gotoCustom('classic/custom_way')">
                                    <h3>Классический</h3>
                                    <p>Стандартная игра без ограничений</p>
                                </div>
                            </div>
                            <div class="game-type col-sm-4">
                                <img src="application/images/game_types/wki_icon-01.png" class="invert" onclick="gotoCustom('one_minute/custom_way')">
                                <div class="game-type-text" onclick="gotoCustom('one_minute/custom_way')">
                                    <h3>На время</h3>
